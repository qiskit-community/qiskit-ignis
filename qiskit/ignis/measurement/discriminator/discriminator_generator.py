...
"""
Base discriminator generator class for making calibrations.
"""
...
class DiscriminatorGenerator:
    """
    Generates calibration circuit for discriminators.
    """
    def __init__(self,
                 num_qubits: int,
                 method: str = 'default',
...
​
        ...
        Args:
            qubits: Optional, apply the N-qubit calibration circuits to these device qubits.
...
​
    ...
    def _calibration_circuit(num_qubits: int, label: str) -> QuantumCircuit:
        ...
        TODO: a full calibration should start by calibrating the X pulse.
        """
        circ = QuantumCircuit(num_qubits, name='discriminator_cal_' + label)
