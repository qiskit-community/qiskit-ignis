...
class BaseDiscriminator(ABC):
    """
    Base discriminator class. Discriminators takes IQ level 1 data produced by
    calibration measurements with a known expected state.
    """

    def count(self):
        """
        Generic method for converting I-Q data to counts. Discriminators
        should implement their specific classification algorithm.
        """
