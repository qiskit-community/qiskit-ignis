                ...
                'expected': {
                    ...
                    'fit':
                        [{'params': np.array([0.70657607, 0.97656138,
                          ...
                          'epc_err': 2.043384967421875e-05,
                          'pepc': 0.011765575131695655,
                          'pepc_err': 0.00014301097468223943},
                         {'params': np.array([0.70689622, 0.97678485,
                                              0.25258977]),
                          'params_err': np.array([0.01243358, 0.00037419,
                                                  0.00027745]),
                          'epc': 0.03441852175571036,
                          'epc_err': 2.6682062385033045e-05,
                          'pepc': 0.011652958127542468,
                          'pepc_err': 0.0001885671003477177}]
                }},
             {
                 'npurity': 9,
                 'rb_opts': {
                 ...
                 'expected': {
                     ...
                     'fit':
                         [{'params': np.array([0.04050766, 0.91275946,
                           ...
                           'epc_err': 0.3008917546314428,
                           'pepc': 0.04428043431358916,
                           'pepc_err': 0.540330382861386},
                          {'params': np.array([0.07347761, 0.68002963,
                                               1.00724559]),
                           'params_err': np.array([1.20673822e+04, 4.60490058e+04,
                                                   1.15476367e-02]),
                           'epc': 0.4031697796194298,
                           'epc_err': 66213.48918045327,
                           'pepc': 0.17001981938110097,
                           'pepc_err': 26182.69327259369}]
                 }}]
