...
it to the `issue tracker <https://github.com/Qiskit/qiskit-ignis/issues>`_.
...
When you contribute to the Qiskit Ignis project with a new pull request, a bot will
...
`Qiskit Ignis <https://github.com/Qiskit/qiskit-ignis>`__ repositories, you can install them
